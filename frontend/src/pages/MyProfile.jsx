...
console.log("Line1:", userData?.address?.line1);
console.log("Line2:", userData?.address?.line2);
  ...
  return userData && (
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>

      {
        ...
        <label htmlFor="image">
           <div className='inline-block relative cursor-pointer'>
            ...
            {image ? null : <img className='w-10 absolute bottom-12 right-12' src={assets.upload_icon} alt="" />}
           </div>
     ...
     {
        isEdit
        ?<input className='bg-gray-50 text-3xl font-medium max-w-60 mt-4 font-medium rounded-lg' 
     ...
     <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit
            ?<input className='bg-gray-100 max-w-52 rounded-lg'
          ...
          <p className='font-medium'>Address:</p>
          {
            ...
            ?<p>
                ...
                <br/>
                <input  className='bg-gray-50 rounded-lg' type="text" value={userData.address.line2}
...
//           <p>
//   {userData?.address?.["line 1"] || "No Address Found"}
//   <br />
//   {userData?.address?.["line 2"] || "No Address Found"}
// </p>
     ...
     <p className='text-neutral-500 underline mt-3'>BASIC INFORMATION</p>
          <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
            ...
            <p className='font-medium'>Birthday:</p>
             {
                isEdit
                ? <input className='max-w-20 bg-gray-100 rounded-lg' type="text" value={userData.dob} onChange={e => setUserData(prev=>({...prev,dob:e.target.value}))} />
